...
from server import DrSimDecisionK8SServer, DrSimDecisionK8SServerAgg
# Gym
...
class DrSimDecisionK8SAgg(wrapt.ObjectProxy):
    _version = '20171127'
    _ALL_ACTIONS = [(ord(mode),) for mode in ['s', 'd', 'a']] + [(0,)]
    def __init__(self, image_uri=None, backend_cmds=None, *args, **kwargs):
        # Simulator Docker image to use
        ...
        _func_compile_obs = DrSimDecisionK8SServerAgg.func_compile_obs
        _func_compile_reward = DrSimDecisionK8SServerAgg.func_compile_reward
        _func_compile_action = DrSimDecisionK8SServerAgg.func_compile_action
