...
tf.app.flags.DEFINE_string("logdir",
                           "/home/pirate03/PycharmProjects/hobotrl/playground/initialD"
                           "/imitaion_learning/docker005_ac",
                           """save tmp model""")
tf.app.flags.DEFINE_string("savedir",
                           "/home/pirate03/hobotrl_data/playground/initialD/exp/docker005_ac_no_early_stopping",
                           """save tmp model""")
...
agent = hrl.ActorCritic(
            ...
            max_advantage=100.0,
            # optimizer arguments
            network_optmizer=hrl.network.LocalOptimizer(tf.train.AdamOptimizer(1e-2), grad_clip=10.0),
            max_gradient=10.0,
            # sampler arguments
            sampler=None,
            batch_size=16,
    ...
    with agent.create_session(config=config, save_dir=FLAGS.logdir, restore_var_list=restore_var_list) as sess:
        while True:
            ...
            while True:
                ...
                reward = func_compile_reward_agent(reward_vec)
