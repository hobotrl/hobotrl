...
from ros_environments.clients import DrSimRuleDecisionK8S
...
def exp(dir_prefix, tf_log_dir="ckpt", our_log_dir="logging", replay_cache_dir="ReplayBufferCache",
    ...
    class FuncReward(object):
        ...
        def _func_skipping_bias(self, reward, done, info, n_skip=1, cnt_skip=0):
            new_info = {}
    ...
    try:
        ...
        env = DrSimRuleDecisionK8S(image_uri='docker.hobot.cc/carsim/simulator_gpu_kub:0.0.10_384.111', backend_cmds=gen_default_backend_cmds(), is_dummy_action=True)
        # Agent
