...
tf.app.flags.DEFINE_string(
    "dir_prefix", "/home/pirate03/hobotrl_data/Compare/rule_learn_q/1",
        ...
        while n_total_steps <= 2.5e5:
            ...
            while True:
                ...
                reward, done, reward_info = reward_vector2scalar(
                    rule_action, vec_reward, done, agent.n_skip, agent.cnt_skip
                )
                agent_info = agent.step(
                    sess=sess, state=state, action=rule_action,
                    reward=reward, next_state=next_state,
                    episode_done=done, vec_reward=vec_reward
                )
                ...
                stepsSaver.save(
                    n_ep, n_ep_steps,
                    state, rule_action, vec_reward, reward, done,
