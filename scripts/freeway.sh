...
. ./scripts/cluster.sh ./test/exp_freeway.py ${exp_name6} 4 1 --log_dir ~/hobotrl/log/Freeway/${exp_name6} --start_port 2355 --start_device 0

exp_name7="Freeway_A3C_half"
. ./scripts/cluster.sh ./test/exp_freeway.py ${exp_name7} 8 1 --log_dir ~/hobotrl/log/Freeway/${exp_name7} --start_port 2365 --start_device 1
